...
console.log("🟠 index.js: Caricamento userRoutes:", typeof userRoutes, userRoutes instanceof require('express').Router ? 'è un Router Express' : 'NON è un Router Express');
