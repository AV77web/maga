...
CREATE TABLE `an_anagrafiche` (
  ...
  `tipo_soggetto` enum('Privato','Azienda','Ente','Altro') DEFAULT 'Azienda',
...
INSERT INTO `an_anagrafiche` VALUES (1,'ACME S.p.a.','ACM000','Azienda'),(2,'Beta S.p.a.','BET000','Azienda'),(3,'Gamma S.n.c','GAM000','Azienda'),(4,'Mario Rossi','ROS000','Privato'),(5,'Tecnologie Avanzate S.p.a.','TEC000','Azienda'),(6,'Logistica Nord S.r.l','LOG000','Azienda'),(7,'Alfa Group','ALF000','Azienda'),(8,'Next Tech','NEX000','Azienda'),(9,'Impresa Verde','IMP000','Azienda'),(10,'Studio Associato Delta','STU000','Azienda');
/*!40000 ALTER TABLE `an_anagrafiche` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `an_contatti`
--

DROP TABLE IF EXISTS `an_contatti`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `an_contatti` (
  ...
  PRIMARY KEY (`id`),
  KEY `sede_id` (`sede_id`),
  CONSTRAINT `an_contatti_ibfk_1` FOREIGN KEY (`sede_id`) REFERENCES `an_sedi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `an_contatti`
--

LOCK TABLES `an_contatti` WRITE;
/*!40000 ALTER TABLE `an_contatti` DISABLE KEYS */;
/*!40000 ALTER TABLE `an_contatti` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `an_indirizzi`
--

DROP TABLE IF EXISTS `an_indirizzi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `an_indirizzi` (
  `id` int NOT NULL AUTO_INCREMENT,
  `sede_id` int NOT NULL,
  `tipo` enum('fatturazione','spedizione','legale','altro') DEFAULT 'spedizione',
  ...
  PRIMARY KEY (`id`),
  KEY `sede_id` (`sede_id`),
  CONSTRAINT `an_indirizzi_ibfk_1` FOREIGN KEY (`sede_id`) REFERENCES `an_sedi` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `an_indirizzi`
--

LOCK TABLES `an_indirizzi` WRITE;
/*!40000 ALTER TABLE `an_indirizzi` DISABLE KEYS */;
/*!40000 ALTER TABLE `an_indirizzi` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `an_nazioni` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) DEFAULT 'Italia',
  PRIMARY KEY (`id`),
...
INSERT INTO `an_nazioni` VALUES (193,'ALBANIA '),(2,'ALGERIA'),(3,'ANDORRA'),(4,'ANGOLA'),(5,'ANGUILLA'),(6,'ANTIGUA AND BARBUDA'),(7,'ARGENTINA'),(8,'ARMENIA'),(9,'ARUBA'),(10,'AUSTRALIA'),(11,'AUSTRIA'),(12,'AZERBAIJAN REPUBLIC'),(13,'BAHAMAS'),(14,'BAHRAIN'),(15,'BARBADOS'),(16,'BELGIO'),(17,'BELIZE'),(18,'BENIN'),(19,'BERMUDA'),(20,'BHUTAN'),(21,'BOLIVIA'),(22,'BOSNIA AND HERZEGOVINA'),(23,'BOTSWANA'),(24,'BRASILE'),(25,'BRITISH VIRGIN ISLANDS'),(26,'BRUNEI'),(27,'BULGARIA'),(28,'BURKINA FASO'),(29,'BURUNDI'),(30,'CAMBOGIA'),(31,'CANADA'),(32,'CAPO VERDE'),(33,'CAYMAN ISLANDS'),(34,'CHAD'),(35,'CHILE'),(36,'CHINA WORLDWIDE'),(42,'CIPRO'),(185,'CITT├Ç DEL VATICANO'),(37,'COLOMBIA'),(38,'COMOROS'),(39,'COOK ISLANDS'),(40,'COSTA RICA'),(41,'CROAZIA'),(45,'DANIMARCA'),(44,'DEMOCRATIC REPUBLIC OF THE CONGO'),(46,'DJIBOUTI'),(47,'DOMINICA'),(49,'ECUADOR'),(50,'EL SALVADOR'),(180,'EMIRATI ARABI UNITI'),(51,'ERITREA'),(52,'ESTONIA'),(53,'ETHIOPIA'),(54,'FALKLAND ISLANDS'),(55,'FAROE ISLANDS'),(56,'FEDERATED STATES OF MICRONESIA'),(57,'FIJI'),(130,'FILIPPINE'),(58,'FINLANDIA'),(59,'FRANCIA'),(60,'FRENCH GUIANA'),(61,'FRENCH POLYNESIA'),(62,'GABON REPUBLIC'),(63,'GAMBIA'),(64,'GERMANIA'),(84,'GIAPPONE'),(65,'GIBRALTAR'),(66,'GRECIA'),(67,'GREENLAND'),(68,'GRENADA'),(69,'GUADELOUPE'),(70,'GUATEMALA'),(71,'GUINEA'),(72,'GUINEA BISSAU'),(73,'GUYANA'),(74,'HONDURAS'),(75,'HONG KONG'),(78,'INDIA'),(79,'INDONESIA'),(80,'IRLANDA'),(77,'ISLANDA'),(81,'ISRAELE'),(82,'ITALIA'),(83,'JAMAICA'),(85,'JORDAN'),(86,'KAZAKHSTAN'),(87,'KENYA'),(88,'KIRIBATI'),(89,'KUWAIT'),(90,'KYRGYZSTAN'),(91,'LAOS'),(92,'LATVIA'),(93,'LESOTHO'),(94,'LIECHTENSTEIN'),(95,'LITUANIA'),(96,'LUSSEMBURGO'),(97,'MADAGASCAR'),(98,'MALAWI'),(100,'MALDIVE'),(99,'MALESIA'),(101,'MALI'),(102,'MALTA'),(111,'MAROCCO'),(103,'MARSHALL ISLANDS'),(104,'MARTINIQUE'),(105,'MAURITANIA'),(106,'MAURITIUS'),(107,'MAYOTTE'),(108,'MESSICO'),(109,'MONGOLIA'),(110,'MONTSERRAT'),(112,'MOZAMBICO'),(113,'NAMIBIA'),(114,'NAURU'),(115,'NEPAL'),(117,'NETHERLANDS ANTILLES'),(120,'NICARAGUA'),(121,'NIGERIA'),(122,'NIUE'),(123,'NORFOLK ISLAND'),(124,'NORWEGIA'),(118,'NUOVA CALEDONIA'),(119,'NUOVA ZELANDA'),(116,'OLANDA'),(125,'OMAN'),(126,'PALAU'),(127,'PANAMA'),(128,'PAPUA NUOVA GUINEA'),(129,'PERU'),(131,'PITCAIRN ISLANDS'),(132,'POLONIA'),(133,'PORTOGALLO'),(134,'QATAR'),(181,'REGNO UNITO'),(43,'REPUBBLICA CECA'),(135,'REPUBBLICA DEL CONGO'),(48,'REPUBBLICA DOMINICANA'),(136,'REUNION'),(137,'ROMANIA'),(139,'RUANDA'),(138,'RUSSIA'),(140,'SAINT VINCENT AND THE GRENADINES'),(141,'SAMOA'),(142,'SAN MARINO'),(144,'SAUDI ARABIA'),(145,'SENEGAL'),(146,'SEYCHELLES'),(147,'SIERRA LEONE'),(148,'SINGAPORE'),(149,'SLOVACCHIA'),(150,'SLOVENIA'),(151,'SOLOMON ISLANDS'),(152,'SOMALIA'),(155,'SPAGNA'),(156,'SRI LANKA'),(157,'ST. HELENA'),(158,'ST. KITTS AND NEVIS'),(159,'ST. LUCIA'),(160,'ST. PIERRE AND MIQUELON'),(182,'STATI UNITI'),(153,'SUD AFRICA'),(154,'SUD KOREA'),(161,'SURINAME'),(162,'SVALBARD AND JAN MAYEN ISLANDS'),(164,'SVEZIA'),(165,'SVIZZERA'),(163,'SWAZILAND'),(166,'TAIWAN'),(167,'TAJIKISTAN'),(168,'TANZANIA'),(169,'THAILAND'),(170,'TOGO'),(171,'TONGA'),(172,'TRINIDAD E TOBAGO'),(173,'TUNISIA'),(174,'TURCHIA'),(175,'TURKMENISTAN'),(176,'TURKS AND CAICOS ISLANDS'),(177,'TUVALU'),(179,'UCRAINA'),(178,'UGANDA'),(76,'UNGHERIA'),(183,'URUGUAY'),(184,'VANUATU'),(186,'VENEZUELA'),(187,'VIETNAM'),(188,'WALLIS AND FUTUNA ISLANDS'),(189,'YEMEN'),(190,'ZAMBIA');
/*!40000 ALTER TABLE `an_nazioni` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `an_ruoli_anagrafica`
--

DROP TABLE IF EXISTS `an_ruoli_anagrafica`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `an_ruoli_anagrafica` (
  `idanagrafica` int NOT NULL,
  `ruolo` enum('cliente','fornitore','partner','agente','altro') NOT NULL,
  PRIMARY KEY (`idanagrafica`,`ruolo`),
  CONSTRAINT `an_ruoli_anagrafica_ibfk_1` FOREIGN KEY (`idanagrafica`) REFERENCES `an_anagrafiche` (`idanagrafica`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `an_ruoli_anagrafica`
--

LOCK TABLES `an_ruoli_anagrafica` WRITE;
/*!40000 ALTER TABLE `an_ruoli_anagrafica` DISABLE KEYS */;
/*!40000 ALTER TABLE `an_ruoli_anagrafica` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `an_sedi` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_anagrafica_sedi` (`idanagrafica`),
  CONSTRAINT `fk_anagrafica_sedi` FOREIGN KEY (`idanagrafica`) REFERENCES `an_anagrafiche` (`idanagrafica`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `an_sedi` VALUES (1,65,'ACME S.p.A.','Azienda','12345678901','ACM123456','Via Roma 1','Via Milano 2','Milano','20100','MI','Italia','025678901','info@acme.it','https://acme.it','Sede legale','2025-07-25 13:51:48','2025-07-25 13:51:48','Marco Bianchi','cliente'),(1,66,'ACME S.p.A.','Azienda','12345678901','ACM123456','Via Torino 4','Via Torino 4','Bergamo','24100','BG','Italia','035123456','filiale@acme.it',NULL,'Filiale','2025-07-25 13:51:48','2025-07-25 13:51:48','Laura Riva','cliente'),(2,67,'Beta S.r.l.','Azienda','23456789012','BETA234567','Via Verdi 10','Via Verdi 10','Torino','10100','TO','Italia','011567890','contatti@beta.it',NULL,NULL,'2025-07-25 13:51:48','2025-07-25 13:51:48','Luisa Verdi','fornitore'),(2,68,'Beta S.r.l.','Azienda','23456789012','BETA234567','Via Po 20','Via Po 20','Torino','10121','TO','Italia','011234567','magazzino@beta.it',NULL,'Magazzino','2025-07-25 13:51:48','2025-07-25 13:51:48','Giorgio Testa','fornitore'),(3,69,'Gamma SNC','Azienda','34567890123','GAM345678','Corso Italia 5','Corso Italia 5','Genova','16100','GE','Italia','010123456','info@gammasnc.it','','','2025-07-25 13:51:48','2025-07-25 13:51:48','Franco Neri','entrambi'),(3,70,'Gamma SNC','Azienda','34567890123','GAM345678','Via Garibaldi 3','Via Garibaldi 3','Savona','17100','SV','Italia','019654321','filiale@gammasnc.it',NULL,'Seconda sede','2025-07-25 13:51:48','2025-07-25 13:51:48','Marta Viola','entrambi'),(4,71,'Mario Rossi','Privato','','RSSMRA70A01H501U','Via Libertà 8','Via Libertà 8','Bologna','40100','BO','Italia','051789012','mario.rossi@email.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Mario Rossi','cliente'),(4,72,'Mario Rossi','Privato','','RSSMRA70A01H501U','Via Zamboni 20','Via Zamboni 20','Bologna','40126','BO','Italia','051000111','altro@email.it',NULL,'Residenza secondaria','2025-07-25 13:51:48','2025-07-25 13:51:48','Mario Rossi','cliente'),(5,73,'Tecnologie Avanzate S.p.A.','Azienda','45678901234','TEC456789','Via Galileo 3','Via Newton 7','Padova','35100','PD','Italia','049123456','contatto@tecav.it','https://tecav.it','Sede operativa','2025-07-25 13:51:48','2025-07-25 13:51:48','Sara Blu','fornitore'),(5,74,'Tecnologie Avanzate S.p.A.','Azienda','45678901234','TEC456789','Via Einstein 9','Via Newton 7','Treviso','31100','TV','Italia','0422123456','sede.tv@tecav.it',NULL,'Sede secondaria','2025-07-25 13:51:48','2025-07-25 13:51:48','Gianni Grigio','fornitore'),(6,75,'Logistica Nord S.r.l.','Azienda','56789012345','LOG567890','Zona Industriale 1','Zona Industriale 1','Verona','37100','VR','Italia','045123789','info@lognord.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Andrea Neri','fornitore'),(6,76,'Logistica Nord S.r.l.','Azienda','56789012345','LOG567890','Via dell?Artigiano 8','Via dell?Artigiano 8','Vicenza','36100','VI','Italia','044498765','vicenza@lognord.it',NULL,'Deposito','2025-07-25 13:51:48','2025-07-25 13:51:48','Chiara Forte','fornitore'),(7,77,'Alfa Group','Azienda','67890123456','ALF678901','Via Alfa 12','Via Beta 34','Firenze','50100','FI','Italia','055789654','info@alfagroup.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Roberto Verdi','cliente'),(7,78,'Alfa Group','Azienda','67890123456','ALF678901','Via Gamma 22','Via Gamma 22','Prato','59100','PO','Italia','0574111222','prato@alfagroup.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Laura Gialla','cliente'),(8,79,'NextTech','Azienda','78901234567','NXT789012','Via Digitale 3','Via Digitale 3','Roma','00100','RM','Italia','0667890123','info@nexttech.it','https://nexttech.it','','2025-07-25 13:51:48','2025-07-25 13:51:48','Elena Rossa','entrambi'),(8,80,'NextTech','Azienda','78901234567','NXT789012','Via del Lavoro 10','Via del Lavoro 10','Napoli','80100','NA','Italia','081123456','napoli@nexttech.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Luca Bianchi','cliente'),(9,81,'Impresa Verde','Azienda','89012345678','IMP890123','Via Verde 1','Via Verde 1','Trento','38100','TN','Italia','0461123456','info@impresaverde.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Marco Forest','cliente'),(9,82,'Impresa Verde','Azienda','89012345678','IMP890123','Via dei Fiori 2','Via dei Fiori 2','Bolzano','39100','BZ','Italia','0471987654','bolzano@impresaverde.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Anna Flora','cliente'),(10,83,'Studio Associato Delta','Azienda','90123456789','STD901234','Via Studio 5','Via Studio 5','Pisa','56100','PI','Italia','050123456','delta@studio.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Davide Blu','cliente'),(10,84,'Studio Associato Delta','Azienda','90123456789','STD901234','Via Archimede 8','Via Archimede 8','Lucca','55100','LU','Italia','058345678','lucca@studio.it',NULL,'','2025-07-25 13:51:48','2025-07-25 13:51:48','Elisa Viola','cliente');
...
CREATE TABLE `ordini` (
  ...
  KEY `fk_ordini_fornitori` (`idanagrafica`),
  CONSTRAINT `fk_ordini_anagrafica` FOREIGN KEY (`idanagrafica`) REFERENCES `an_anagrafiche` (`idanagrafica`) ON DELETE RESTRICT ON UPDATE CASCADE
...
BEGIN
    ...
    IF p_order_by NOT IN ('id_ordine', 'num_ordine', 'data_ordine', 'idanagrafica', 'stato', 'magazzino_origine', 'magazzino_destinazione') THEN
    ...
    WITH filtered AS (
        SELECT
            o.id_ordine, o.num_ordine, o.data_ordine, o.idanagrafica, o.stato, o.magazzino_origine,
            o.magazzino_destinazione, o.data_consegna_prevista, o.priorita, o.vettore, o.tipo_trasporto,
            o.valuta, o.listino, o.sconto_totale, o.condizioni_pagamento, o.aliquota_iva,
            o.documento_collegato, o.utente_creazione, o.created_at, o.updated_at, o.causale, o.note,
            a.rag_soc,
            s.partita_iva, s.indirizzo_fatturazione, s.indirizzo_spedizione
        FROM ordini o
        JOIN an_anagrafiche a ON o.idanagrafica = a.idanagrafica
        LEFT JOIN an_sedi s ON o.idanagrafica = s.idanagrafica
        WHERE (p_num_ordine IS NULL OR o.num_ordine LIKE CONCAT('%', p_num_ordine, '%'))
          AND (p_idanagrafica IS NULL OR p_idanagrafica = 0 OR o.idanagrafica = p_idanagrafica)
          AND (p_data_da IS NULL OR o.data_ordine >= p_data_da)
          AND (p_data_a IS NULL OR o.data_ordine <= p_data_a)
    ),
    grouped AS (
        SELECT
            id_ordine,
            MAX(num_ordine) AS num_ordine, MAX(data_ordine) AS data_ordine, MAX(idanagrafica) AS idanagrafica, MAX(stato) AS stato,
            MAX(magazzino_origine) AS magazzino_origine, MAX(magazzino_destinazione) AS magazzino_destinazione, MAX(data_consegna_prevista) AS data_consegna_prevista,
            MAX(priorita) AS priorita, MAX(vettore) AS vettore, MAX(tipo_trasporto) AS tipo_trasporto, MAX(valuta) AS valuta,
            MAX(listino) AS listino, MAX(sconto_totale) AS sconto_totale, MAX(condizioni_pagamento) AS condizioni_pagamento,
            MAX(aliquota_iva) AS aliquota_iva, MAX(documento_collegato) AS documento_collegato, MAX(utente_creazione) AS utente_creazione,
            MAX(created_at) AS created_at, MAX(updated_at) AS updated_at, MAX(causale) AS causale, MAX(note) AS note,
            MAX(rag_soc) AS rag_soc, MAX(partita_iva) AS partita_iva, MAX(indirizzo_fatturazione) AS indirizzo_fatturazione,
            MAX(indirizzo_spedizione) AS indirizzo_spedizione
        FROM filtered
        GROUP BY id_ordine
    ),
    paginated AS (
        ...
        ORDER BY
            CASE v_order_by_safe
                WHEN 'id_ordine' THEN g.id_ordine
                WHEN 'num_ordine' THEN g.num_ordine
                WHEN 'data_ordine' THEN g.data_ordine
                WHEN 'idanagrafica' THEN g.idanagrafica
                WHEN 'stato' THEN g.stato
                WHEN 'magazzino_origine' THEN g.magazzino_origine
                WHEN 'magazzino_destinazione' THEN g.magazzino_destinazione
            END
        LIMIT p_page_size OFFSET v_offset
    ),
    total_count AS (
        SELECT COUNT(*) AS totalRows FROM grouped
    )
    SELECT JSON_OBJECT(
        'status', 'success',
        'page', p_page,
        ...
        'data', JSON_ARRAYAGG(
            JSON_OBJECT(
                ...
                'data_consegna_prevista', DATE_FORMAT(data_consegna_prevista, '%Y-%m-%d'),
                'priorita', priorita,
                'vettore', vettore,
...
-- Dump completed on 2025-07-28 17:51:36
