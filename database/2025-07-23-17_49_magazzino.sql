    ...
    paginated AS (
        ...
        ORDER BY
            CASE v_order_by_safe
                ...
                WHEN 'controparte_id' THEN controparte_id
...
-- Dump completed on 2025-07-23 17:49:34
