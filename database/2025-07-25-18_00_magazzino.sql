...
BEGIN
    ...
    WITH filtered AS (
        ...
        WHERE (p_num_ordine IS NULL OR num_ordine LIKE CONCAT('%', p_num_ordine, '%'))
          AND (p_idanagrafica IS NULL OR p_idanagrafica = 0 OR idanagrafica = p_idanagrafica)
    ...
    paginated AS (
        ...
        ORDER BY
            CASE v_order_by_safe
                ...
                WHEN 'idanagrafica' THEN o.idanagrafica
...
-- Dump completed on 2025-07-25 18:01:03
