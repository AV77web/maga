...
INSERT INTO `an_anagrafiche` VALUES (1,'ACME S.p.a.','ACM000'),(2,'Beta S.p.a.','BET000'),(3,'Gamma S.n.c','GAM000'),(4,'Mario Rossi','ROS000'),(5,'Tecnologie Avanzate S.p.a.','TEC000'),(6,'Logistica Nord S.r.l','LOG000'),(7,'Alfa Group','ALF000'),(8,'Next Tech','NEX000'),(9,'Impresa Verde','IMP000'),(10,'Studio Associato Delta','STU000');
...
BEGIN
    ...
    WITH filtered AS (
        SELECT
            ...
            a.rag_soc,
            s.partita_iva, s.indirizzo_fatturazione, s.indirizzo_spedizione, s.contatto
        FROM ordini o
    ...
    grouped AS (
        SELECT
            ...
            MAX(indirizzo_spedizione) AS indirizzo_spedizione, MAX(contatto) AS contatto
        FROM filtered
        GROUP BY id_ordine
    ),
    paginated AS (
...
-- Dump completed on 2025-07-27 23:29:34
