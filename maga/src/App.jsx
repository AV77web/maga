...
import { Routes, Route, Navigate, useNavigate , useLocation } from "react-router-dom"; // ✅ basta questo
...
function App() {
  ...
  return (
    <>
      ...
      <Sidebar1 isSidebarOpen={isSideBarOpen} closeSidebar={closeSidebar} onLogout={handleLogout} currentUser={currentUser} currentLocation={location.pathname}  />
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute isLoggedIn={loggedIn} userRole={currentUser?.role}>
              <MovimentiTable currentUser={currentUser} onLogout={handleLogout} currentLocation={location.pathname}  />
            </ProtectedRoute>
          }
        />
        <Route
        ...
        <Route
          ...
          element={
            <ProtectedRoute isLoggedIn={loggedIn} userRole={currentUser?.role}>
              <ArticoliTable currentUser={currentUser} onLogout={handleLogout} currentLocation={location.pathname}  />
            </ProtectedRoute>
          }
        />
        <Route
          ...
          element={
            <ProtectedRoute isLoggedIn={loggedIn} userRole={currentUser?.role}>
              <CausaliTable currentUser={currentUser} onLogout={handleLogout} currentLocation={location.pathname} />
            </ProtectedRoute>
          }
        />
