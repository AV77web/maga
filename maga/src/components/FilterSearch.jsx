...
// @version: "1.1.1 2025-06-25" // Aggiornata versione con fix warning key
//=====================================================
            ...
            {field.type === 'select' ? (
              ...
              >
                <option key="default-option" value="">
                  {field.placeholder || `Seleziona ${field.label || field.name}`}
                </option>
                {(field.options || []).map((option, index) => {
                  // fallback key per evitare warning React
                  const key = option.value != null ? option.value.toString() : `option-${index}`;
                  return (
